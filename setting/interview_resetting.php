  ...
  <div class="row">
    ...
    <div class="col-sm-10">
      ...
      <div class="text-center">
        <a class="btn btn-info" href="interview_resetting_01.php?interview_id=<?= h($_SESSION["interview_id"]); ?>&interview_style=1" disabled>ビデオ面接予約</a>&emsp;
        <a class="btn btn-primary" href="interview_resetting_01.php?interview_id=<?= h($_SESSION["interview_id"]); ?>&interview_style=2">通常面接予約</a>&emsp;　
