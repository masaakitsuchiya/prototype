    ...
    <div class="col-sm-10">
      <form class="form-group form-horizontal" action="job_post_update.php" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <textArea id="job_description" class="form-control" name="job_description" rows="10" cols="80"><?= hd($res["job_description"]);?></textArea>
          </div>
          <script>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <textArea id="requirement" class="form-control" name="requirement" rows="10" cols="80"><?=hd($res["requirement"]);?></textArea>
          </div>
          <script>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <textArea id="salary_system" class="form-control" name="salary_sys" rows="10" cols="80"><?=hd($res["salary_sys"]);?></textArea>
          </div>
          <script>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <textArea id="welfare" class="form-control" name="welfare" rows="10" cols="80"><?= hd($res["welfare"]); ?></textArea>
          </div>
          <script>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <textArea id="work_hour" class="form-control" name="work_hour" rows="10" cols="80"><?= hd($res["work_hour"]);?></textArea>
          </div>
          <script>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <textArea id="etc" class="form-control" name="etc" rows="10" cols="80"><?= hd($res["etc"]);?></textArea>
          </div>
          <script>
