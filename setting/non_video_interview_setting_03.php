...
//mail_default_text抽出
$stmt_mail_text = $pdo->prepare("SELECT nonvideo_interview_invite FROM default_mail_text");
...
<div class="container">
  <div class="row">
    ...
    <div class="col-sm-10">
      <form class="form-group form-horizontal" action="non_video_interview_setting_insert.php" method="post">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <span class="help-block">候補者へのメールに入る文章です。必要に応じて編集してください</span>
            <textarea name="mail_text" style="width:90%; height:300px;"><?php if($_SESSION["interview_type_num"] == 1){echo "この度は弊社求人に応募いただきありがとうございます。";}elseif($_SESSION["interview_type_num"] == 2 || $_SESSION["interview_type_num"] == 3){echo "先日は面接にご対応いただきありがとうございました。検討の結果次のステップに進んでいただきたいと存じます。";} ?><?= h($res_mail_text["nonvideo_interview_invite"]); ?></textarea>
          </div>
        </div>
        <div class="form-group">
          <input type="hidden" name="interview_style" value="2">
          <input type="hidden" name="csrf_token" value="<?= $csrf_token ?>">
        </div>
        <div class="text-center">
          <a class="btn btn-default" href="non_video_interview_setting_02.php?interview_id=<?php echo($_SESSION["interview_id"]);?>">戻る</a>
