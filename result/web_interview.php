...
#receive_mobile span.user_name{
  color:#ddd;
  font-size:0.3em;
}

#pc_chat_area  span.user_name{
  color:#ddd;
}
          ...
          <div class="col-sm-6">
            ...
            <div id="btn_area" class="text-center">
              <div class="btn-group" role="group">
                ...
                <!-- <button class="btn btn-info" id="list">list_print</button> -->
              </div>
            </div>
          </div>
...
<script>
  ...
  multiparty.on('my_ms', function(video) {
    ...
    $(vNode).appendTo('#self_video');
      ...
      //     flg: 1
      //   }
      // multiparty.send(user_name_data);
      // console.dir(user_name_data);
  ...
  $('.receive').append('<div class="text-left"><span class="user_name">'+ mesg.data.user_name +'</span><br><div class="peer_message">' + mesg.data.message_text + '</div></div>');
  ...
  $("#message form").on("submit", function(ev) {
        ...
        if(data.length > 0) {
          ...
          // メッセージを接続中のpeerに送信する
          multiparty.send(name_and_message);
          $text.val("");
        }
    });
...
//   var list = multiparty.listAllPeers()
//   console.log(list);
// });
