...
//３．データ登録SQL作成
$stmt = $pdo->prepare("INSERT INTO interviewee_info(id,interviewee_name,interviewee_name_kana,job_post_id,birthday,sex,mail,postcode,address,github,portfolio,resume0,resume1,resume2,indate
