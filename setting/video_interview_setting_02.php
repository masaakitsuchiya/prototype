...
if($status==false){
  ...
  //Selectデータの数だけ自動でループしてくれる
    $res = $stmt->fetch();
    $view_interviewer_name .= h($res["interviewer_name"]);
...
<div class="container">
  <div class="row">
    ...
    <div class="col-sm-10">
      <form class="form-group form-horizontal" action="video_interview_setting_03.php" method="post">
        ...
        <div class="text-center">
          <a class="btn btn-default" href="video_interview_setting_01.php?target_interviewee_id=<?php echo($_SESSION["interviewee_id"]);?>&interview_type_num=1">戻る</a>
          &emsp;
