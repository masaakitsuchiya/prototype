...
//３．データ登録SQL作成
$stmt = $pdo->prepare("INSERT INTO job_post(id, job_title, job_img, job_description, requirement, salary_sys, estimate_income, welfare, location, work_hour, etc, life_flg,
indate)VALUES(NULL, :job_title, :job_img, :job_description, :requirement, :salary_sys, :estimate_income, :welfare, :location, :work_hour, :etc, :life_flg, sysdate())");
