    ...
    <div class="row" >
     ...
     <div class="row control-panel text-center">
           <div class="btn-group" role="group">
             <a class="btn btn-info btn-lg" type="button" name="start" id="start"><i class="glyphicon glyphicon-facetime-video"></i></a>
             <!-- <a class="btn btn-info" type="button" name="exit" id="exit" disabled ><i class="glyphicon glyphicon-remove-circle"></i> 退出</a> -->
             <a class="btn btn-info btn-lg" type="button" id="video-mute" data-muted="false" disabled><i class="glyphicon glyphicon-facetime-video"></i><i class="glyphicon glyphicon-remove" style="font-size:0.3em;"></i></a>
             <a class="btn btn-info btn-lg" type="button" id="audio-mute" data-muted="false" disabled><i class="glyphicon glyphicon-volume-off"></i></a>
           </div>
     </div>
  </div>
